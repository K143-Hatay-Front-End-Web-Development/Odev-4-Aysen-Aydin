...
const PRIVATE_KEY = "36bbec11e0b3a72f12110e7b6a8c2a640088fb83";
const PUBLIC_KEY = "0a5d656cea40eae9ce45cfa90a9704fc";
...
export const heroApi = createApi({
  ...
  endpoints: (builder) => ({
    getHeroes: builder.query({
      query: () => ({
        url: `characters?apikey=${PUBLIC_KEY}&hash=${hash}&ts=1`,
        method: "get",
      }),
      // query: (name) => `characters?apikey=${PUBLIC_KEY}&hash=${hash}&ts=1`,
      transformResponse: (data) => data.data.results,
    }),
    getHero: builder.query({
      query: ({ id }) => ({
        url: `characters/${id}?apikey=${PUBLIC_KEY}&hash=${hash}&ts=1`,
        method: "get",
      }),
      // query: (name) => `characters?apikey=${PUBLIC_KEY}&hash=${hash}&ts=1`,
      transformResponse: (data) => data.data.results,
...
export const { useGetHeroesQuery, useLazyGetHeroQuery } = heroApi;
